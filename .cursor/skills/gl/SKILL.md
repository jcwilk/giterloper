...
Pin add automatically clones and indexes; no separate clone/index steps needed.
...
- Confirm with the user before destructive actions (pin remove, subtract, intersect).
