/**
 * Branch validation and working clone management.
 */
...
export function ensureWorkingClone(state: GlState, pin: Pin): string {
...
export function pushBranchOrFail(dir: string, pin: Pin, operationName: string): void {
