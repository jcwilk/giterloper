...
export function commandOutput(data: unknown, asJson: boolean = false): void {
  if (asJson) {
...
export function consumeBooleanFlag(args: string[], longName: string): ConsumeBooleanFlagResult {
