...
export function detectGpuMode(): { mode: "cuda" } | { mode: "cpu"; reason?: string } {
...
export function printCudaInstallInstructions(): void {
  info("");
...
export function ensureGpuConfig(state: GlState): void {
