...
export interface GpuDetectResult {
  mode: "cuda" | "cpu";
  reason?: "no-toolkit" | "no-gpu";
}

export function detectGpuMode(): GpuDetectResult {
...
export function printCudaInstallInstructions(infoFn: (msg: string) => void): void {
  ...
  infoFn("  wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2404/x86_64/cuda-keyring_1.1-1_all.deb");
