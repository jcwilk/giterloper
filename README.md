...
- **`gl` skill** — `.cursor/skills/gl/` provides the skill metadata and a thin wrapper; the CLI logic lives in `lib/` (TypeScript).
...
2. From this repo: `node .cursor/skills/gl/gl.mjs clone` then `node .cursor/skills/gl/gl.mjs index`
