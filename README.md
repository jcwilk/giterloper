...
2. From this repo: `./.cursor/skills/gl/scripts/gl-extended clone` then `./.cursor/skills/gl/scripts/gl-extended index` (or add a pin with `gl pin add` which materializes automatically)
