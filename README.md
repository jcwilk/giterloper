...
2. From this repo: `./.cursor/skills/gl/scripts/gl-extended clone` then `./.cursor/skills/gl/scripts/gl-extended index` (or add pins with `gl pin add`, which clones and indexes automatically)
