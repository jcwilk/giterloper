...
const TOP_HELP = [
  ...
  "",
  "Global Options:",
  "  --session-id <id>   Session id for state (default: _cli)",
  "  --mcp-test-mode     MCP test mode: .giterloper_test + TEST_KNOWLEDGE_STORE_REMOTE (harness).",
  "                      With this flag, optional GITERLOPER_MCP_TEST_SESSION_PARENT may override",
  "                      the parent directory of .giterloper_test (ignored when flag absent; specs/core.md).",
  "",
  "Commands:",
