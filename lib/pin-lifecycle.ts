...
/**
 * Updates a pin's SHA in pinned.yaml. Called by internal lifecycle (insert, reconcile, merge).
 * Pin name may be SESSION_PIN_NAME; validation applies only at API input boundary, not here.
 */
