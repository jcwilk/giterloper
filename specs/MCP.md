...
For **motivation, architecture, and example workflows** (research intake vs embedded knowledge), see **[specs/product-context.md](./product-context.md)**—explanatory only; it does not override this file or sibling area specs.
